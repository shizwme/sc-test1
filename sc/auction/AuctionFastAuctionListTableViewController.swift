...
class AuctionFastAuctionListTableViewController: BaseTableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        let d : NSDictionary = ["pageNow" : pageNow];
        initParam(params: d);
        
        getHttpJSONData(url: AppConstant.baseUrl + "carData/fauctionListCarDataFastAuction",
                        method: HTTPMethod.get, parameters: alamofireParameters);
    }
    
    override func parseJson(josnStr: Any) -> Bool {
        print("解析数据");
        return true;
    }
